...
try {
  ...
  const demoTourModifyUrl =
    'https://eden.tours/book/376197a7-8701-40d2-9a81-23bd5f47b53c?action=QnChkR1DMEfCcPtX9VdbhZ'
  const demoTourUnsubscribeUrl =
    'https://eden.tours/user/unsubscribe?action=VrJteFNn8uPs6NRvcs5p2G'
  const demoTourTimeUrl =
    'http://localhost:3000/book/376197a7-8701-40d2-9a81-23bd5f47b53c/time'
  ...
  let samples = [
    ...
    },
    {
      name: 'tour-confirmed',
      type: 'html',
      body: templates.createConfirmationEmailHtml(
        demoTourName,
        demoTourDates,
        demoTourNumConnections,
        demoTourModifyUrl,
    ...
    },
    {
      name: 'tour-confirmed',
      type: 'txt',
      body: templates.createConfirmationEmailPlaintext(
        demoTourName,
        demoTourDates,
        demoTourNumConnections,
        demoTourModifyUrl,
